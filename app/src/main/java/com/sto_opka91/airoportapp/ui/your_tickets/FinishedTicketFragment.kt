...
@AndroidEntryPoint
class FinishedTicketFragment : Fragment() {

    private var _binding: FragmentFinishedTicketBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFinishedTicketBinding.inflate(inflater, container, false)
        return binding.root
    }
