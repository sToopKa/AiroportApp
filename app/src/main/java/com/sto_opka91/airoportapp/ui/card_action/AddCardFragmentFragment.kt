...
@AndroidEntryPoint
class AddCardFragmentFragment : Fragment() {
    private var _binding: FragmentAddCardFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAddCardFragmentBinding.inflate(inflater, container, false)
    ...
    private fun initListeners() = with(binding) {
        ...
        btnBuyTicket.setOnClickListener {
            showInform(requireContext(), "Далее производится оплата по карте с помощью выбранного эквайринга")
        }
